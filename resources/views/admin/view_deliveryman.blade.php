  ...
  <table>
    ...
    @foreach ($deliverymans as $deliveryman)
        <tr>
          ...
          <td><form action="{{ url('/del_deliveryman') }}" method="POST">
    @csrf
    <input type="hidden" name="id" value="{{ $deliveryman->id }}">
    <button type="submit" class="take-appointment-link" onclick="return confirm('Are you sure you want to remove the deliveryman?')">Remove Deliveryman</button>
</form>
</td>
        </tr>
      @endforeach
