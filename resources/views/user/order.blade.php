  ...
  <body>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div>
            ...
            @endif
            <form action="{{url('upload_order')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <dev align="center">
                    <label>Name</label>
                ...
                <dev align="center">
                <label>Amount</label>
                <input type="number" name="amount" placeholder="Enter medicine type" required="">
                </dev>
                ...
                <select name="order_list" required="">
